...
```
Most common is GG gaplotype with probability of 0.7555556.




## Task 7 (2p)
#### Compute 4 LD statistics for all the marker pairs in this data base (D, D', Ï2 and R2). Make a scatterplot matrix of these. Is there an exact linear relationship between Ï2 and R2 ? Why (not) so?
