...
## Task 9. (2p) 
#### Make two LD heatmaps of the markers in this database, one using the R2 statistic and one using R^2 the D' statistic, and use the positional information on the markers. Are the results consistent? 
