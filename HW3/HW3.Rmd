...
LDheatmap(output$`D'`, LDmeasure="D'", add.map=TRUE, title="D' LD heatmap",color=rgb.palette(18))
LDheatmap(output$`R^2`,LDmeasure="r", add.map=TRUE, title="R^2 LD heatmap",color=rgb.palette(18))
```
