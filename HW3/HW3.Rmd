...
## Task5 (2p)
#### Given your previous estimate of D, and using the formulae from the lecture slides, compute the statistics D', ??2, R2 and r by hand for the first pair of SNPs. Do your results coincide with those obtained by the LD function? Can you explain possible differences? - nope, cannot
```{r echo=FALSE}
print(geno_loci[1:2,])
